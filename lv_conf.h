...
#ifndef KEYBOARD_GUIDE_LVGL_USE_SDL
#define KEYBOARD_GUIDE_LVGL_USE_SDL 0
#endif

#ifndef KEYBOARD_GUIDE_LVGL_FS_POSIX_PATH
#define KEYBOARD_GUIDE_LVGL_FS_POSIX_PATH ""
#endif
...
#define LV_USE_FS_POSIX 1
    ...
    #define LV_FS_POSIX_PATH KEYBOARD_GUIDE_LVGL_FS_POSIX_PATH /**< Set the working directory. File/directory paths will be appended to it. */
...
#define LV_USE_SDL              KEYBOARD_GUIDE_LVGL_USE_SDL
#if LV_USE_SDL
...
/** Driver for /dev/fb */
#define LV_USE_LINUX_FBDEV      (!KEYBOARD_GUIDE_LVGL_USE_SDL)
